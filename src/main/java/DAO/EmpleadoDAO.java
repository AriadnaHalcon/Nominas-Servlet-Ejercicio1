...
public class EmpleadoDAO {
    ...
    public List<Empleado> obtenerEmpleadosSueldo() throws SQLException, DatosNoCorrectosException {
        ...
        Nomina nomina = new Nomina();  // Crear una instancia de Nomina
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                // Calcular el sueldo usando la instancia de Nomina
                int sueldo = nomina.sueldo(empleado);
                empleado.setSueldo(sueldo);  // Asegúrate de que haya un método setSueldo en Empleado
